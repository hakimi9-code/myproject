      ...
      <div className="stats-section">
        ...
        <div className="category-bars">
          {stats.salesByCategory?.map((item) => {
            ...
            return (
              <div key={`cat-${item.category}`} className="category-bar-item">
        ...
        <div className="recent-orders">
          {stats.recentOrders?.length > 0 ? (
            stats.recentOrders.map((order) => (
              <div key={`order-${order.id}`} className="recent-order-item">
      ...
      <div className="stats-section">
        ...
        <div className="monthly-chart">
          {stats.monthlySales?.map((item) => {
            ...
            return (
              <div key={`month-${item.month}`} className="chart-bar-container">
                <div 
                  className="chart-bar" 
                  style={{ height: `${height}%` }}
